...
contract gameChannel {
    ...
    ERC20 token = ERC20(0x95a48dca999c89e4e284930d9b9af973a7481287); // contract address
    OwnedStore store = OwnedStore(0xe195eed0e77b48146aa246dadf987d2504ac88cb); // not to change
