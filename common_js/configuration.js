...
function changeNet(value){
	...
	switch(value){
		case "ropsten":
			...
			erc20address = "0x95a48dca999c89e4e284930d9b9af973a7481287"; // contract address
			// dice
			addressDice = "0x6a8f29e3d9e25bc683a852765f24ecb4be5903fc"; // diceroll contract address
			// blackjack
